#!/usr/bin/env Rscript
# =============================================================================
# Plot: Asian Papers Distribution Trend
# =============================================================================
# Generates (box + violin + scatter) plot showing distribution of asian accepted papers
...
OUTPUT_PDF <- "outputs/plots/asian_trend_distribution.pdf"
...
main <- function() {
  message("Generating asian papers distribution plot...")
  ...
  plot <- pipeline_continent_trend_distribution(
    csv_path = INPUT_CSV,
